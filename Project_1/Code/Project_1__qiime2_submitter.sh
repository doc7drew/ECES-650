...
containerdir=/Project_1
SINGULARITYENV_containerdir=${containerdir} singularity exec --fakeroot --bind .:${containerdir},${TMP}:/tmp,${TMP}:${TMP} /ifs/groups/eces450650Grp/containers/qiime_amplicon_2025.7.sif bash ${containerdir}/Project_1.sh
